...
HF_ENDPOINT=https://hf-mirror.com accelerate launch --config_file accelerate_cfg/1m4g_fp16.yaml train_scripts/train_spo.py --config configs/spo_config/spo_reward_aigi_sd-v1-4.py