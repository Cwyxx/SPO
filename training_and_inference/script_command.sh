...
HF_ENDPOINT=https://hf-mirror.com accelerate launch --config_file accelerate_cfg/1m4g_fp16.yaml train_scripts/train_diffusion_dpo.py --config configs/diffusion_dpo_config/diffusion_dpo-sd-v1-4.py